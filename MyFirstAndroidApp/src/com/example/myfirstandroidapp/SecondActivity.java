...
public class SecondActivity extends Activity {
    ...
    final WheelView players = (WheelView) findViewById(R.id.HoleSelection);
    
    players.setVisibleItems(18);
    ...
    players.setViewAdapter(adapter);
    players.setCurrentItem(0);
    
    players.addChangingListener(new OnWheelChangedListener() {
...
private  void refreshGameStatus() {
		...
		// get hole number
		final WheelView holeEditText = (WheelView) findViewById(R.id.HoleSelection);
		holeEditText.setCurrentItem(holeNum);
